    ...
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <div className="bg-[#F9F7F2] p-6 rounded">
                ...
                <p className="font-body font-medium text-[#121212] mb-4">
          ...
          <div className="mb-16 pb-16 border-b border-[#E8E3DA]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div
                  key={idx}
                  className="border-b border-[#E8E3DA] pb-6 last:border-0"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="font-heading text-lg font-bold text-[#121212]">
                      {dish.name}
                    </h4>
                    <span className="font-body font-medium text-[#C5A059]">
                      {dish.price}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Bourbon, bitters, sugar, and a hint of orange zest",
              },
              {
                name: "Luxe Mojito",
                description:
              ...
              },
              {
                ...
                description:
                  "Gin, vermouth, olives, and served with distinction",
              },
            ].map((cocktail, idx) => (
              <div key={idx} className="p-6 bg-[#F9F7F2]">
                ...
                <p className="font-body text-sm text-[#121212]">
      ...
      <section className="section-padding bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="heading-2 text-[#121212] mb-6">Make a Reservation</h2>
